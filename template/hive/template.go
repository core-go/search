...
func Merge(obj map[string]interface{}, format StringFormat, j int, skipArray bool, separator string, prefix string, suffix string) TStatement {
...
func UseQuery(isTemplate bool, query func(interface{}) string, id string, m map[string]*Template, modelType *reflect.Type, mp func(interface{}, *reflect.Type) map[string]interface{}, opts ...func(string) string) (func(interface{}) string, error) {
	if !isTemplate {
		return query, nil
	}
...
func UseQueryBuilder(isTemplate bool, builder Builder, id string, m map[string]*Template, modelType *reflect.Type, mp func(interface{}, *reflect.Type) map[string]interface{}, opts ...func(string) string) (Builder, error) {
	if !isTemplate {
		return builder, nil
	}
	return NewQueryBuilder(id, m, modelType, mp, opts...)
}
func NewQueryBuilder(id string, m map[string]*Template, modelType *reflect.Type, mp func(interface{}, *reflect.Type) map[string]interface{}, opts ...func(string) string) (*QueryBuilder, error) {
	t, ok := m[id]
	if !ok || t == nil {
