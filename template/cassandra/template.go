...
func Merge(obj map[string]interface{}, format StringFormat, param func(int) string, j int, skipArray bool, separator string, prefix string, suffix string) TStatement {
